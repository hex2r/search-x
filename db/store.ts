export const store = {
  results: [
    ...
    },
    {
      ...
      description:
        "The World Wide Web Consortium is the main international standards organization for the World Wide Web. Founded in 1994 and led by Tim Berners-Lee, the consortium is made up of member organizations that maintain full-time staff working together in the development of standards for the World Wide Web.",
    },
    {
      id: "2",
      ...
      title: "Google inc.",
      description:
        "Google is an American-based multinational corporation and technology company focusing on online advertising, search engine technology, cloud computing, computer software, quantum computing, e-commerce, consumer electronics, and artificial intelligence",
    },
    {
      id: "3",
    ...
    },
    {
      ...
      description:
        "Google Hangouts was a cross-platform instant messaging service developed by Google. It originally was a feature of Google+, becoming a standalone product in 2013, when Google also began integrating features from Google+ Messenger and Google Talk into Hangouts.",
    },
    {
      id: "5",
    ...
    },
    {
      ...
      title: "CSS Tricks",
      description:
        "CSS Tricks from 2009, the year I started regularly following the site. I first heard about Chris and the site from a Boagworld podcast on my commute to work. Last week, Chris Coyier shared a post about his March 2022 sale of CSS Tricks to DigitalOcean and where things are at today.",
    },
    {
      id: "10",
      url: "https://workspace.google.com",
      title: "Google Workspace",
      description: "Create, connect, and collaborate with the power of AI",
    },
    {
      id: "11",
      url: "https://css-tricks.com",
    ...
    {
      id: "13",
      url: "https://www.special-characters.com",
      title: "Special chars &|!@#$%^&*()<>?\"}{[];',./`~",
      description: "&|!@#$%^&*()<>?\"}{[];',./`~",
    },
  ],
